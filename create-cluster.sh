...
sed "s/AWS_REGION/${AWS_REGION}/g;s/ARN_NUMBER/${ARN_NUMBER}/g;s/CLUSTER_NAME/${CLUSTER_NAME}/g;s/PRIVATE_SUB1_ID/${PRIVATE_SUB1_ID}/g;s/PRIVATE_SUB2_ID/${PRIVATE_SUB2_ID}/g;s/PUBLIC_SUB1_ID/${PUBLIC_SUB1_ID}/g;s/PUBLIC_SUB1_ID/${PUBLIC_SUB2_ID}/g;s/VPC_ID/${VPC_ID}/g" cluster-template.yaml > ${AWS_REGION}-${CLUSTER_NAME}.yaml
# cluster creation
